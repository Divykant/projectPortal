...
import logo from "../../../Images/Admin/akglogo.jpg";
      ...
      <nav className="navbar">
        <div className="left">
          <div className="navbarLeft">
            ...
            <h1 onClick={nav} className="admin_text">
              ADMIN
            </h1>
          </div>
        </div>
        <div className="right">
          <div className="navbarRight">
            <div className="buttonWrapper">
              ...
              <Link to="/leaderboard">
                <button className="but leaderboard">
                  <p style={{ fontSize: "22px" }} className="buttonText">
                    LEADERBOARD
                  </p>
                </button>
              </Link>
